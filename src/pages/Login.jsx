...
const Login = () => {
  ...
  //   // Example usage:
  //   login('65130413@dpu.ac.th', '12345678');
    ...
    if (email != "" && password != "") {
      ...
      try {
        fetch("https://api-mixnmatch-ig1a.vercel.app/api/login", {
          ...
          .then((res) => res.json())
          .then((result) => {
            if (result["roleshow"] == "webadmin") {
              alert(result["message"]);

              navigate("/admin/requestjoin");
            } else if (result["roleshow"] == "shopadmin") {
              if (result["isActive"] == 1) {
                alert(result["message"]);
                navigate("/admin/dashboard");
              } else {
                alert("โปรดรอเจ้าหน้าที่อนุมัติบัญชี");
                return;
              }
            } else if (result["roleshow"] == "customer") {
              alert("This Role Can't Access!");
            } else {
              alert("อีเมลล์หรือรหัสผ่าน ไม่ถูกต้อง");
            }
            console.log("Login successful:", result); // Access response data
            // console.log("ARRAY BRANCHID:", result["branchId"][1]);
            signIn({
              auth: {
                token: result["token"],
                type: "Bearer",
        ...
        console.error("Login error c:", error);
      }
    } else {
      alert("กรุณากรอก E-mail Password");
    }
  };
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <h1 className="text-3xl font-bold">Mix N Match</h1>
              <p className="font-custom text-2xl text-gray-700 py-3">
                {" "}
                {/* Hello {auth.userid} */}
                ระบบจัดการสำหรับผู้ดูแลร้าน
              </p>
              ...
              <p className="2xl:px-20">{/* Sign In */}</p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2"></h2>
              <h1 className="text-3xl font-bold">เข้าสู่ระบบ</h1>
              <p className="font-custom text-2xl text-gray-700 py-3">
                {" "}
                เข้าสู่ระบบสำหรับจัดการร้านค้า
              </p>
              ...
              <form onSubmit={onSubmit}>
                <div className="mb-4">
                  ...
                  <div className="relative">
                    <input
                      ...
                      onChange={handleEmailChange} // Attach onChange handler
                    />
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none "
                      //dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary
                      value={password} // Bind email state to input value
                      onChange={handlePassChange} // Attach onChange handler
                    />
                ...
                <div className="mt-6 text-center py-5">
                  <p>
