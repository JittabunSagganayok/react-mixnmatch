...
const SignUp = () => {
  ...
  const [shoptype, setType] = useState("");
    ...
    if (
      ...
      try {
        fetch("https://api-mixnmatch-ig1a.vercel.app/branch", {
          ...
          .then((res) => res.json())
          .then((result) => {
            console.log("create branch successful:", result.id_branch);
            var datauser = {
              email: email,
              username: username,
              password: password,
            ...
            fetch("https://api-mixnmatch-ig1a.vercel.app/api/register", {
              ...
              .then((result) => {
                ...
                alert(
                  "ลงทะเบียนสำเร็จ โปรดรอเจ้าหน้าที่ตรวจสอบและติดต่อกลับ เพื่อทำการอนุมัติ"
                );
        ...
        console.error("create branch error c:", error);
      }
    } else {
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              ...
              <h1 className="text-3xl font-bold">
                เข้าร่วมกับเรา Join Our Partner
              </h1>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              {/* <h1 className="text-3xl font-bold py-3">
                ลงทะเบียนสำหรับจัดการร้านค้า
              </h1> */}
              <p className="font-custom text-2xl text-black font-bold">
                {" "}
                ลงทะเบียนสำหรับจัดการร้านค้า
              </p>
              ...
              <form onSubmit={onSubmit}>
                <div className="mb-4">
                  <p className="font-custom text-xl text-gray-700 py-4">
                    {" "}
                    1.กรอกข้อมูลร้านค้า
                  </p>
                ...
                <div className="mb-4">
                  <p className="font-custom text-xl text-gray-700 py-4">
                    {" "}
                    2.กรอกข้อมูลผู้ดูแลร้านค้า (ShopAdmin)
                  </p>
